...
import { ArrowLeft, Share2, SquareArrowOutDownRight, SquareArrowOutUpRight } from "lucide-react";
...
const EditForm = ({ params }) => {
  ...
  return (
    <div className="p-10">
      ...
      >
        <Button className="flex gap-2 bg-green-500 hover:bg-green-700"> <Share2 className="h-5 w-5" /> Share</Button>
      </RWebShare>
